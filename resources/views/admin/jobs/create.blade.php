                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="full_description" id="full_description" cols="30" rows="10"></textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="job_nature" type="text" name="job_nature" value="{{ old('job_nature') }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" cols="30" rows="10" width="100"></textarea>
